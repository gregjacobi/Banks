...
const financialStatementSchema = new mongoose.Schema({
  ...
  // Credit Quality data from RC-N Schedule (Past Due and Nonaccrual Loans)
  creditQuality: {
    ...
    summary: {
      ...
      totalNonperforming: Number,  // Nonaccrual + 90+ days past due
      totalPastDueAndNonaccrual: Number
    }
  },
  // Charge-offs and Recoveries from RI-B Schedule
  ...
  // Validation totals for data integrity checks
  validationTotals: {
    totalRealEstateLoans: Number,
    totalLoansGross: Number,
    totalLoansNet: Number,
    allowanceForLosses: Number
  },
  // Categorized loan totals (Consumer vs Business breakdown)
  loanCategories: {
    consumer: {
      total: Number,
      mortgage: Number,
