...
**Report Structure:**
Follow this 6-chapter structure for consistency across presentations and podcasts:
...
**NEW SECTION** - Start with the bank's top 2-3 strategic priorities. This should be the first substantive section after the executive summary.

**Priority Identification:**
1. Check management documents (investor presentations, earnings calls) for explicitly stated priorities
2. If not available, infer from:
   - Major changes in business mix (e.g., shift toward wealth management)
   - Technology investments and digital transformation initiatives
   - Recent acquisitions or expansion plans
   - Headcount growth patterns (where are they hiring?)
   - Public statements by leadership

**For each priority, provide:**
- Clear statement of the priority (e.g., "Digital transformation and AI integration")
- Evidence and progress metrics (cite specific data)
- Impact on financial performance
- Comparison to peer banks (are peers pursuing similar strategies?)
- Use relevant charts to show progress (e.g., <chart:efficiency-ratio /> for efficiency initiatives)

**Example Structure:**
### Priority 1: Improving Operational Efficiency
The bank has committed to reducing its efficiency ratio from 68% to 60% by Q4 2026 [Source 1]. Recent initiatives include consolidating branches and automating back-office processes. The efficiency ratio improved 280bp YoY to 65.2% [Call Report: Q2 2025], ahead of the peer average of 63.1%. <chart:peer-efficiency />

# 3. Key Financial Ratios
**CRITICAL:** Focus on these FOUR KEY METRICS and compare against peers (this section moved up for strategic clarity):
